...
const mockADPics = [
  "https://th.bing.com/th/id/OIP.RTUkorUEnVUk044LNJAhdQHaHa?rs=1&pid=ImgDetMain",
  "https://th.bing.com/th/id/OIP.cABRQ8a9i-NbiPe77VWG_wHaEK?w=1280&h=720&rs=1&pid=ImgDetMain",
  "https://web.doorzo.cn/data/Upload/d3df8d328986f710cc7b4eab604e1e3a.jpg",
];
...
const Home = () => {
  ...
  const [data, setData] = useState<{ [key: string]: WaterfallItem[] }>({
    热门: mockData.slice(0, 50),
    最新: mockData.slice(50),
  });
